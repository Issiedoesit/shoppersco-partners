...
const EditCampaignModal = ({isModalOpen, closeModal}) => {
  ...
  return (
    <PopUpWrap id={'editCampaignModal'} modalStoreState={isModalOpen} handleModal={closeModal}>
            ...
            <div className='bg-brandGreen4x rounded-t-ten py-2.5 px-5 sm:px-10 md:px-14 w-full'>
                <h2 className='text-white font-avenirBlack text-2xl md:text-3xl'>Edit Campaign</h2>
            </div>
