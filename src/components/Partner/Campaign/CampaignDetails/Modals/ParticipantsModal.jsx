...
const ParticipantsModal = ({isModalOpen, closeModal, data}) => {
  ...
  return (
    <PopUpWrap id={'participantsModal'} paddingY={'pt-20 lg:py-0'} modalStoreState={isModalOpen} handleModal={closeModal}>
        <div className='bg-white mx-auto lg:m-auto rounded-ten z-50 w-ninetyFivePercent sm:w-sixtyFivePercent md:w-sixtyPercent lg:w-fiftyPercent h-eightyPercent lg:h-eightyFivePercent overflow-hidden flex flex-col'>
            ...
            <div className='overflow-hidden flex flex-col pb-10 h-full'>
